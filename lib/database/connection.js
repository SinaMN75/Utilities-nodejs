...
var sequelizeDatabase = function (host, database, username, password, dialect) {
...
function connectToSequelize(host, database, username, password, dialect) {
    (0, exports.sequelizeDatabase)(host, database, username, password, dialect).authenticate()
